...
const Reservation = ({ passFormData }) => {
  ...
  return (
    <div
      className="pt-10 pb-16 h-screen bg-cover bg-center"
      style={{ backgroundImage: `url('${backgroundImageUrl}')` }}
    >
      <form
        onSubmit={handleSubmit}
        className="max-w-md mx-auto p-4 border rounded bg-gray-50"
      >
        <div className="">
          <div className="text-center mt-2 mb-8">
            <h1 className="text-md font-bold mb-1">TABLE RESERVATION</h1>
            <span className="text-md text-gray-500">
              Make table reservation at QRAnbessa.
            </span>
          </div>
          <input
            type="text"
        ...
        <button
          type="submit"
          className="bg-gray-500 mt-3 text-white p-2 rounded-md border-2  border-transparent hover:border-black hover:bg-white hover:text-black sm:text-center"
        >
          Submit
        </button>
      </form>
