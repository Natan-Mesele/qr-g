  ...
  const [jsonData, setJsonData] = useState({
    items: [
      ...
      },
      {
        id: 2,
        image:
          "http://res.cloudinary.com/dsskh3fao/image/upload/v1701927338/fwr3x08jn3qv0mruqzje.jpg",
        title: "Cake",
        ptitle: "50 Br.",
      },
      {
      ...
      },
      {
        id: 4,
        image:
          "http://res.cloudinary.com/dsskh3fao/image/upload/v1703482054/vfxjg7gj5evzoicgkuen.jpg",
        title: "Coffee",
        ptitle: "30 Br.",
      },
      {
            ...
            >
              <div className="sm:flex gap-4">
                <img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-28 bg-cover sm:h-24 object-cover rounded-md"
                />
